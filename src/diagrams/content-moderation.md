...
C4Container
  ...
  Rel(api, s3raw, "issue presigned upload URL")
  Rel(api, postgres, "create submission record; serve results and review items")
  Rel(api, redis, "push to priority queue on low-confidence; pop next review item")
  Rel(enterprise_user, s3raw, "PUT content via presigned URL", "HTTPS multipart or PUT")
