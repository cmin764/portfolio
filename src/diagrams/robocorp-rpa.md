...
C4Container
  ...
  UpdateElementStyle(dev, $bgColor="#dbe4ff", $borderColor="#748ffc", $fontColor="#1e1e1e")
  UpdateElementStyle(rcc, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(taskPkg, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(tasks, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(libBrowser, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(libDesktop, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(libDocs, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(libCloud, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(libData, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(libLog, $bgColor="#96f2d7", $borderColor="#099268", $fontColor="#1e1e1e")
  UpdateElementStyle(artifacts, $bgColor="#ffd8a8", $borderColor="#e8590c", $fontColor="#1e1e1e")
```
